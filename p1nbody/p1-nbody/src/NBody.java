...
public class NBody {
	...
	public static CelestialBody[] readBodies(String fname) throws FileNotFoundException {
		...
		CelestialBody [] bodies = new CelestialBody[numB];
		for(int i=0; i <numB; i++) {
			bodies[i] = new CelestialBody(s.nextDouble(), s.nextDouble(), s.nextDouble(), s.nextDouble(), s.nextDouble(), s.next());

		} 
		s.close();       // # bodies to be read
		return bodies;
		}
